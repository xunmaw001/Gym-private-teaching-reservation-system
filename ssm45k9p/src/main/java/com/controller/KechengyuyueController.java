...
public class KechengyuyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechengyuyueEntity kechengyuyue, 
		...
		if(tableName.equals("jiaolian")) {
			kechengyuyue.setJiaolianbianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("huiyuan")) {
			kechengyuyue.setHuiyuankahao((String)request.getSession().getAttribute("username"));
		}
