...
public class DingdanxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanxinxiEntity dingdanxinxi, 
		...
		if(tableName.equals("huiyuan")) {
			dingdanxinxi.setHuiyuankahao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaolian")) {
			dingdanxinxi.setJiaolianbianhao((String)request.getSession().getAttribute("username"));
		}
