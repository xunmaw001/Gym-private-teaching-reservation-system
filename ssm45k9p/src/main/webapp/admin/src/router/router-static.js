...
import center from '@/views/center'
    ...
    import yuejiesuantongji from '@/views/modules/yuejiesuantongji/list'
    ...
    import zongjiesuantongji from '@/views/modules/zongjiesuantongji/list'
...
const routes = [{
	...
	path: '/jiaolian',
      ...
      ,{
	path: '/yuejiesuantongji',
        name: '月结算统计',
        component: yuejiesuantongji
      }
      ,{
	path: '/huiyuan',
        name: '会员',
	...
	path: '/config',
      ...
      ,{
	path: '/zongjiesuantongji',
        name: '总结算统计',
        component: zongjiesuantongji
      }
    ]
  },
  {
