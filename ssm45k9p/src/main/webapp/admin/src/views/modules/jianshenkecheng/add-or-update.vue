    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="健身效果" prop="jianshenxiaoguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="健身效果"
                  v-model="ruleForm.jianshenxiaoguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianshenxiaoguo" label="健身效果" prop="jianshenxiaoguo">
                    <span>{{ruleForm.jianshenxiaoguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../ssm45k9p/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
